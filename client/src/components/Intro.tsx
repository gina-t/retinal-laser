...
export function Intro() {
  return (
    <>
      ...
      <p className="mt-4 text-base/6 text-gray-900">
        Laser therapy is performed in the outpatient setting. After dilating the pupil, topical anaesthetic is applied. You are seated at the slit lamp laser, and instucted to look at an external target. A 3-mirror contact lens is applied to the cornea, and the retinal tear brought into the ophthalmologist's focused view. Contiguous laser spots are applied to the edges of the tear, usually in 3 neat rows. There is usually no pain. After the procedure your ophthalmologist will advise you not to drive or to return to work that day, and not to lift more than 20kg for about 2 weeks post laser therapy. 
      </p>
